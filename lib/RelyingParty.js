...
var RelyingParty = function () {
  function RelyingParty() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        provider = _ref$provider === undefined ? {} : _ref$provider,
        defaults = _ref.defaults,
        _ref$registration = _ref.registration,
        registration = _ref$registration === undefined ? {} : _ref$registration,
  ...
  _createClass(RelyingParty, [{
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
        var rp, validation, jwks;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                rp = new RelyingParty(data);
                validation = rp.validate();
              ...
              case 4:
                ...
                return _context.abrupt('return', rp.jwks().then(function () {
                  return rp;
                }));

              case 7:
                return _context.abrupt('return', JWKSet.importKeys(jwks).then(function (jwks) {
